...
const Card = (props) => {
  ...
  return (
    <div className="mt-8 flex flex-col p-2.5 text-base hover:border hover:border-black items-center bg-zinc-100 w-120 h-60 hover:rounded-none rounded-sm text-xl">
